...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable  allowedInShutdown
        ...
        builder.put("@Promote",                 new Config(null,                                           false, false, false, 0,    VoltType.INVALID,   false, false, true,  true,      false,    false));
        ...
        builder.put("@ResetDRSingle",           new Config("org.voltdb.sysprocs.ResetDRSingle",            false, false, false, 0,    VoltType.INVALID,   true,  false, true,  true,      false,    false));
